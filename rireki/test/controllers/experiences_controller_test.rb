...
class ExperiencesControllerTest < ActionController::TestCase
  ...
  test "should create experience" do
    assert_difference('Experience.count') do
      post :create, experience: { company: @experience.company, date: @experience.date, description: @experience.description, title: @experience.title }
    end
  ...
  test "should update experience" do
    patch :update, id: @experience, experience: { company: @experience.company, date: @experience.date, description: @experience.description, title: @experience.title }
    assert_redirected_to experience_path(assigns(:experience))
  end
